    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <img src="https://via.placeholder.com/200x60?text=Ghosi+Community" alt="Company Logo" class="logo">
          <h1 class="title">OTP Verification</h1>
          <p class="subtitle">Secure access to your Ghosi Community account</p>
        </div>
        
        <p>Hello <span class="highlight">${firstName}</span>,</p>
        <p>Thank you for registering with Ghosi Community. To complete your registration, please enter the following One-Time Password (OTP):</p>
        ...
        <p>If you didn't request this OTP, please ignore this email or contact our support team immediately at <a href="mailto:support@ghosicommunity.com">support@ghosicommunity.com</a>.</p>
        ...
        <div class="footer">
          <p>© ${new Date().getFullYear()} Ghosi Community. All rights reserved.</p>
          <p>123 Community Street, Ghosi Town, India</p>
          <p>
